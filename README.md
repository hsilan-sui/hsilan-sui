...
| 專案名 | 展示 | 程式碼 | 應用技能 |
|-----|--------|-------- |--------|
| 公仔辨識結帳專案  | [Demo連結](https://www.youtube.com/watch?v=b0CbNcgBwGQ&t=41s) | [Github連結](https://github.com/hsilan-sui/ToyVisionPay_project/tree/main?tab=readme-ov-file)| `Node.js` `Express` `PostgreSQL` `TypeORM` `Firebase Storage` `Docker` `Line Bot API` |
